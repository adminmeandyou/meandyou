-- =============================================
-- SISTEMA DE ROLETA — Migration (versao segura, pode re-rodar)
-- Execute no Supabase SQL Editor
-- =============================================

-- 1. Tabela roleta_prizes
...
-- 4. Coluna incognito_until na tabela profiles (se nao existir)
