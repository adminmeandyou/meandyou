...
const CONDITION_LABELS: Record<string, (val: number) => string> = {
  ...
  messages_sent_gte:    (v) => `Enviar ${v} ${v === 1 ? 'mensagem' : 'mensagens'}`,
  messages_received_gte:(v) => `Receber ${v} ${v === 1 ? 'mensagem' : 'mensagens'}`,
  messages_total_gte:   (v) => `Trocar ${v} ${v === 1 ? 'mensagem' : 'mensagens'}`,
