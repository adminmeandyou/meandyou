...
const faqFallback: FaqItem[] = [
  ...
  { q: 'Por que não existe um plano gratuito permanente?', a: 'Porque o gratuito permanente atrai quem não sabe o que quer. Um valor acessível (a partir de R$14,90) cria um filtro imediato. Quem investe para estar aqui, por menor que seja o valor, tem outro nível de intenção. Você percebe a diferença já na primeira mensagem.' },
