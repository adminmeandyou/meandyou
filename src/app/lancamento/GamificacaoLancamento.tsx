        ...
        <div className="lp-gamif-v2-grid">
          {[
            ...
            },
            {
              ...
              texto: 'Entre todos os dias e desbloqueie recompensas crescentes no calendário mensal. Quem começar agora no lançamento já chega com vantagem de streak no histórico.',
              tag: 'Começa hoje',
            },
            {
              anim: 'pulse',
