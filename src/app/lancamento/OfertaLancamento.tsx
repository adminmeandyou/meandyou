    ...
    <section className="lp-section-v2 lp-section-v2--dark">
      <div className="lp-section-inner-v2">
        <div className="lp-anim" style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <p className="lp-section-label" style={{ marginBottom: 16 }}>Por dentro do lancamento</p>
          <h2 style={{ fontFamily: 'var(--font-fraunces), serif', fontSize: 'clamp(28px,4vw,44px)', fontWeight: 700, lineHeight: 1.15, marginBottom: 20, color: 'var(--text)' }}>
            Nao e um app gratuito.<br /><em style={{ color: 'var(--accent)', fontStyle: 'italic' }}>E uma oportunidade.</em>
          </h2>
          <p style={{ fontSize: 'clamp(15px,2vw,17px)', color: 'rgba(248,249,250,0.60)', lineHeight: 1.8, marginBottom: 12 }}>
            O MeAndYou e uma plataforma paga — e vai continuar sendo. Quem paga, leva a experiencia a serio. E isso muda o nivel de todo mundo dentro do app.
          </p>
          <p style={{ fontSize: 'clamp(15px,2vw,17px)', color: 'rgba(248,249,250,0.60)', lineHeight: 1.8, marginBottom: 40 }}>
            Mas antes de abrir para o mundo, precisamos de pessoas reais testando, explorando, e nos dizendo o que ainda pode melhorar. Entao fizemos uma troca justa: voce usa tudo por 2 meses. Nos coletamos feedback real. Depois, se quiser continuar, e R$9,97/mes. Se nao quiser, cancela. Sem pressao, sem truque.
          </p>
        </div>
          ...
          {[
            {
              ...
              titulo: '2 meses gratis',
              desc: 'Plano Essencial completo, sem pagar nada. Voce acessa, testa, usa de verdade.',
            },
            {
              ...
              desc: 'Lendario. Vitalicio. Nunca mais sera concedido. Voce carrega no perfil para sempre.',
            },
            {
              ...
              titulo: 'Depois: so R$9,97/mes',
              desc: 'Plano Essencial apos o periodo. Cancele a qualquer momento, sem burocracia.',
            },
          ].map((item, i) => (
            <div key={i} style={{
        ...
        <div className="lp-anim" style={{ textAlign: 'center', marginTop: 40 }}>
          <a href="/cadastro" style={{
            ...
            Quero participar do lancamento
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></svg>
          </a>
          <p style={{ marginTop: 12, fontSize: 13, color: 'rgba(248,249,250,0.35)' }}>
            2 meses gratis · Plano Essencial · Depois R$9,97/mes · Cancele quando quiser
          </p>
        </div>
      </div>
    </section>
