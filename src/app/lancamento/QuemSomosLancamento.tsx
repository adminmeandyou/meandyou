...
export default function QuemSomosLancamento() {
  return (
      ...
      <div className="lp-about-inner">
        <div className="lp-about-pillars">
          <div className="lp-about-pillar lp-anim">
            ...
            <h4>O mais inclusivo do Brasil, talvez do mundo.</h4>
            <p>Não importa sua raça, identidade de gênero, religião, se você é PCD, assexual ou qual é a sua orientação. Com mais de 100 filtros, você molda o app em volta de você. Nós nos recusamos a criar apenas mais um app. Construímos a primeira plataforma com arquitetura de inclusão total.</p>
          </div>
          <div className="lp-about-pillar lp-anim">
            <div className="lp-about-pillar-label">Por que lançamento</div>
            <h4>Estamos começando aqui, antes de abrir para o mundo.</h4>
            <p>O MeAndYou nasceu com uma visão global, mas toda grande plataforma precisa começar de algum lugar. Estamos começando pela nossa cidade, crescendo com feedback real, e ajustando o que precisa antes de escalar. Quem entra agora ajuda a moldar o que o app vai ser. E fica com o emblema que prova isso.</p>
          </div>
          <div className="lp-about-pillar lp-anim">
