...
// Secoes adaptadas para o lancamento
...
// Secoes reutilizadas sem alteracao (conteudo produto, nao copy)
...
export default function LancamentoPage() {
  ...
  // Fake notifications — foco em lancamento
  useEffect(() => {
    if (checking) return
  ...
  return (
    <div className="lp">
      ...
      {/* Hero — CTA de lancamento */}
      <HeroLancamento userCity={userCity} notifList={notifList} />

      {/* Identificacao com a dor + bridge para solucao */}
      <IdentLancamento />

      {/* Pilares — o que e diferente + contexto gratuito */}
      <PilaresLancamento />

      {/* Verificacao — produto, universal */}
      <VerificacaoSection />

      {/* Modos — header adaptado: todos incluidos nos 2 meses */}
      <ModosLancamento />

      {/* Filtros — demo interativo, produto universal */}
      <FiltrosSection />

      {/* Intencoes — produto universal */}
      <IntencoesSection />

      {/* Seguranca — produto universal */}
      <SegurancaSection />

      {/* Gamificacao — adaptado: acumula desde o primeiro dia, emblema lendario */}
      <GamificacaoLancamento />

      {/* Encontro — jornada do match ao encontro, produto universal */}
      <EncontroSection />

      {/* Perfil — produto universal */}
      <PerfilSection />

      {/* Backstage — exclusivo Black */}
      <BackstageSection />

      {/* NOVA: Explicacao honesta da oferta */}
      <OfertaLancamento />

      {/* Planos — Essencial em destaque com oferta de 2 meses */}
      <PlanosLancamento />
      ...
      {/* Quem somos — com contexto do lancamento */}
      <QuemSomosLancamento />

      {/* FAQ — focado em perguntas do lancamento */}
      <FaqLancamento />
