      ...
      <div className="lp-back-v2-inner">
        <div className="lp-anim">
          ...
          <div style={{ display:'flex', gap:12, alignItems:'center', marginTop:24, flexWrap:'wrap' }}>
            <a href="/planos" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'12px 24px', borderRadius:12, background:'linear-gradient(135deg,#F59E0B,#d97706)', border:'none', color:'#000', fontSize:14, fontWeight:700, textDecoration:'none' }}>
              Ver o plano Black
