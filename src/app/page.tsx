...
export default function Home() {
  ...
  const faqItems = [
    ...
    { q: 'Como funciona a videochamada?', a: 'Matches podem se videoconversar pelo app. O tempo disponível depende do plano: 1h/dia no Essencial, 5h/dia no Plus e 10h/dia no Black.' },
  ]
  ...
  return (
    <>
      ...
      <div className="lp">
          ...
          <div className="lp-hero">
            <div>
              <div className="lp-badge">
                ...
                Verificação real de identidade · Filtros que importam
              </div>
              <h1>Encontre alguém <em>de verdade.</em></h1>
              <p className="lp-hero-sub">
                O app de relacionamentos com <strong>verificação rigorosa</strong> e os filtros mais completos do Brasil.
              </p>
              ...
              <div className="lp-stats">
                <div>
                  ...
                  <div className="lp-stat-label">Perfis verificados</div>
                </div>
                <div className="lp-stat-div"></div>
                <div>
                  <div className="lp-stat-val">50+</div>
                  <div className="lp-stat-label">Filtros disponíveis</div>
                </div>
                <div className="lp-stat-div"></div>
                <div>
                  <div className="lp-stat-val">Anti-golpe</div>
                  <div className="lp-stat-label">Sistema ativo 24h</div>
                </div>
              </div>
            </div>
                ...
                <div className="lp-phone">
                  ...
                  <div className="lp-phone-card">
                    <div className="lp-phone-img">
                      👩
                      <div className="lp-v-badge">✓ Verificada</div>
                    </div>
        ...
        <section className="lp-problem">
          <div className="lp-problem-inner">
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,.55)', fontSize: '16px', lineHeight: 1.7 }}>
        ...
        <section className="lp-verification" id="verificacao">
          <div className="lp-verification-inner">
            <div>
              ...
              <p style={{ color: 'var(--lp-muted)', fontSize: '16px', marginTop: '14px' }}>
        ...
        {/* ── Como funciona ── */}
        <section style={{ padding: '100px 56px', background: 'var(--lp-bg)' }} id="como-funciona">
          <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div className="lp-steps-row">
              {[
                { icon: '💳', t: 'Escolha seu plano', d: 'A partir de R$10/mês. Sem conta gratuita — isso garante qualidade.' },
                { icon: '✅', t: 'Verifique sua identidade', d: 'Selfie ao vivo + documento. Menos de 3 minutos pelo celular.' },
                { icon: '🎯', t: 'Configure seus filtros', d: 'Inclua e exclua como quiser. 50+ opções para ser preciso.' },
                { icon: '💚', t: 'Dê match e conecte', d: 'Só pessoas reais, com intenções compatíveis com as suas.' },
              ].map((step, i) => (
                <div key={i} className="lp-how-step">
                  <div className="lp-step-icon" style={{ fontSize: '28px' }}>{step.icon}</div>
                  <h3>{step.t}</h3>
                  <p>{step.d}</p>
                </div>
              ))}
        ...
        <section className="lp-pricing" id="precos">
          <div className="lp-pricing-inner">
            ...
            <h2 className="lp-section-title">
              Sem conta gratuita.<br />
              <em style={{ fontStyle: 'italic', color: 'var(--lp-accent)' }}>Mais seriedade.</em>
            </h2>
            <div className="lp-cards">
              ...
              <div className="lp-card">
                ...
                <p className="lp-plan-desc">O ponto de entrada. Para quem quer explorar a plataforma com segurança.</p>
                ...
                {/* Botão redireciona para cadastro com plano pré-selecionado */}
                <a href="/cadastro?plano=essencial" className="lp-btn-price lp-btn-outline-p">
                  Assinar Essencial
                </a>
              </div>
              ...
              <div className="lp-card mid">
                ...
                <p className="lp-plan-period">por mês</p>
                <p className="lp-plan-desc">A experiência completa com todos os recursos de filtragem da plataforma.</p>
                <ul className="lp-feats">
                  <li>Verificação de identidade</li>
              ...
              <div className="lp-card vip">
                ...
                <p className="lp-plan-period">por mês</p>
                <p className="lp-plan-desc">Você acessa todos os perfis e tem área exclusiva Backstage com total privacidade.</p>
                <ul className="lp-feats">
        ...
        <footer className="lp-footer">
          <div className="lp-footer-top">
            ...
            <div className="lp-footer-col">
              <h4>Legal</h4>
              {/* ✅ Páginas criadas — links funcionam */}
