    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lp-phone-header { background: var(--bg); padding: 36px 20px 18px; text-align: center; display: flex; flex-direction: column; align-items: center; border-bottom: 1px solid var(--border); }
                ...
                <div
                  ...
                  <div className="lp-phone-header">
                    <div className="lp-phone-logo">
                      <img src="/logo.png" alt="MeAndYou" style={{ height: '108px', maxWidth: '220px', objectFit: 'contain' }} />
                    </div>
