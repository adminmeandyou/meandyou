...
import { Pencil, X, Star, Heart, MessageCircle } from 'lucide-react'
...
export function DesktopActions({ isOwnProfile, onEditProfile, onSwipe, hasMatch, matchId }: ActionButtonsProps) {
  return (
...
export function MobileActionBar({ isOwnProfile, onEditProfile, onSwipe, hasMatch, matchId }: ActionButtonsProps) {
  return (
